...
This project contains CSS styling derived from Bear Blog (https://bearblog.dev) by Herman Martinus.

The original Bear Blog is licensed under the Bear Blog License 2.0:
...
Tiny Blog is a derivative work. The Python code is original, but the CSS is based on Bear Blog's stylesheet.

This project is distributed under the same Bear Blog License 2.0 terms.
